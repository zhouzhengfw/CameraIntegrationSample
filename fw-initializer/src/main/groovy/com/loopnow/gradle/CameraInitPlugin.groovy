...
class CameraInitPlugin implements Plugin<PluginAware> {
    ...
    void apply(PluginAware target) {
         ...
         if (target instanceof Project) {
            ...
            def fwLibraryVersion = "1.4.3.1-test"
            if (target.getPlugins().hasPlugin(AppPlugin.class)){
                ...
                android.defaultConfig.addManifestPlaceholders(Map.of("envPermission",android.defaultConfig.getApplicationId()) )
                android.defaultConfig.addManifestPlaceholders(Map.of("envProviderFilter",android.defaultConfig.getApplicationId()) )
//                manifestPlaceholders["envPermission"] = "com.firework.sdkdemo"
//                manifestPlaceholders["envProviderFilter"] = "com.firework.sdkdemo"
